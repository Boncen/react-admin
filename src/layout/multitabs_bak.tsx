  ...
  const renderRightClickDropdownMenu = () => {
    return (
      <Dropdown.Menu>
        ...
        <Dropdown.Item
          key={"closeTab"}
          onClick={() => handleCloseTab(rightClickItemkey)}
        >
          {t("sys.tab.close")}
        </Dropdown.Item>
        <Dropdown.Item
          key={"closeOthers"}
          onClick={() => closeOthers(rightClickItemkey)}
        >
        ...
        <Dropdown.Item
          key={"closeLeft"}
          onClick={() => closeLeft(rightClickItemkey)}
        >
          {t("sys.tab.closeLeft")}
        </Dropdown.Item>
        <Dropdown.Item
          key={"closeRight"}
          onClick={() => closeRight(rightClickItemkey)}
        >
      ...
      {tabs.map((l) => (
        ...
        >
          <div
            ...
            style={{ height: "calc(100vh - 108px)", msOverflowStyle: "none" }}
          >
            {l.children}
          </div>
        </TabPane>
